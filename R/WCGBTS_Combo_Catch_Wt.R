WCGBTS_Combo_Catch_Wt <- function (Species = "Sebastes pinniger", YearRange = c(2003, 2015), verbose = FALSE) 
{
    ...
    SP.Before <<- SP
    SP <- rename_columns(SP, newname = c("Year", "Vessel", "Scientific_Name", 
        "Wt_kg", "Tow"))
    SP.After <<- SP
